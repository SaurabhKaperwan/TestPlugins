...
class CineSimklProvider: MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "/tv/genres/a/kr/all-networks/all-years/popular-today?limit=$mediaLimit" to "Trending Korean Shows",
   ...
   private suspend fun extractImdbInfo(
    ...
    private suspend fun runAnimeInvokers(
        ...
        runAllAsync(
            ...
            { invokeXDmovies(tmdbId, imdbSeason, imdbEpisode, subtitleCallback, callback) },
