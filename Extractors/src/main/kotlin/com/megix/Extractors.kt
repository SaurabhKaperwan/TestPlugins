    ...
    override suspend fun getUrl(
        ...
        if (urlValue.isNotEmpty()) {
            ...
            div?.select("h2 a.btn")?.amap {
                ...
                val text = it.text()
                val classString = it.attr("class")

                if (classString.contains("btn-success")) {
                ...
                else if (classString.contains("btn-danger")) {
...
open class GDFlix : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        document.select("div.text-center a").amap { anchor ->
            ...
            val classString = anchor.attr("class")
            ...
            when {
                ...
                classString.contains("btn-outline-success") -> {
                    callback.invoke(
                ...
                classString.contains("btn-success") -> {
                    val baseUrlLink = getBaseUrl(link)
                    val finalURL = if (link.contains("download", true)) link
                        else "$baseUrlLink/api/file/${link.substringAfterLast("/")}?download"
                    callback.invoke(
                ...
                classString.contains("btn-danger") -> {
                    try {
